...
/*   Updated: 2023/04/29 19:34:33 by yorlians         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	create_images(t_game *game)
{
	...
	game -> image.enemy_child = put_image(GOOGOOGAGA_XPM, game);
	game -> image.enemy_d_child = put_image(DEMON_SPAWN_XPM, game);
}
